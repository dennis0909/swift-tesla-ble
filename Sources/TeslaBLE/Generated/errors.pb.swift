...
private let _protobuf_package = "Errors"
...
extension Errors_NominalError: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try decoder.decodeSingularEnumField(value: &genericError)
            default: break
            }
        }
    }
    ...
    public func traverse(visitor: inout some SwiftProtobuf.Visitor) throws {
        if genericError != .genericerrorNone {
            try visitor.visitSingularEnumField(value: genericError, fieldNumber: 1)
        }
